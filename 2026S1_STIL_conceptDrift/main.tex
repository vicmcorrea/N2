...
automatically yield a cleaner unrestricted candidate list. The third limitation
is temporal granularity: yearly slicing is appropriate for a first comparative
baseline, but it compresses within-year shocks, campaign cycles, and short-lived
institutional disputes that may matter for political language.
...
reliable comparison targets. A symbolic companion analysis using lexical
